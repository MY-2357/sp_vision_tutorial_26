...
static const cv::Point3f point_1 = cv::Point3f(0.0,-150.0,0.0);
static const cv::Point3f point_2 = cv::Point3f(-150.0, 0.0, 0.0);
static const cv::Point3f point_3 = cv::Point3f(0.0, 150.0, 0.0);
static const cv::Point3f point_4 = cv::Point3f(150.0, 0.0, 0.0);
static const cv::Point3f point_5 = cv::Point3f(0.0, 0.0, 0.0);
static const cv::Point3f point_6 = cv::Point3f(0.0, 382.0/2+330.0, 0.0);
